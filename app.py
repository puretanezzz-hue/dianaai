...
TOKEN = os.getenv("8479714875:AAHwEUERvI0nwg3Ev-Y7H4IVcAhPLD0BpbA")          # сюда потом вставишь токен от BotFather
GROK_KEY = os.getenv("xai-4SrF3XvYC8JuC9LSGv5rhRt79thTgS6cCbj7bQonQCnwi11FbyIMCf8gWLCDmDQahHBVlhMZ4HSJ9V4a")    # сюда ключ от xAI
